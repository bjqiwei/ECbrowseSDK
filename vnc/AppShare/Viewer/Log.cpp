...
const int vLog::ToDebug   =  1;
const int vLog::ToFile    =  2;
const int vLog::ToConsole =  4;

const static int LINE_BUFFER_SIZE = 1024;

vLog::vLog(int mode, int level, LPTSTR filename, bool append)
{
    hlogfile = NULL;
    m_todebug = false;
    m_toconsole = false;
...
void vLog::SetFile(LPTSTR filename, bool append) 
{
...
void vLog::ReallyPrint(LPTSTR format, va_list ap) 
{
