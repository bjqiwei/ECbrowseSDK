...
{
	char buffer[300];
	sprintf(buffer,"vncEncodeTight w:%d h:%d\n",rect.right - rect.left,rect.bottom-rect.top);
...
{
	OutputDebugString("SendFullColorRect\n");
							 ...
							 int zlibLevel, int zlibStrategy)
{
	...
	{
		deflateEnd(&m_zsStruct[streamId]);
		m_zsActive[streamId] = false;
	}
	//end
...
{
	OutputDebugString("SendJpegRect\n");
