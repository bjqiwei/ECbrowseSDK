...
public:
	...
	static unsigned __stdcall	CheckUpdatesThread(LPVOID lpVoid);
	// Create/Destroy methods
	vncDesktop(BOOL bRecordScreen = FALSE);
	~vncDesktop();
...
protected:
	...
	HANDLE      m_hKillClient ;
	HANDLE		m_hTryThread;		// handle of send thread 
