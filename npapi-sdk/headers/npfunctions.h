...
typedef struct _NPPluginFuncs {
  ...
  //NPP_DidCompositePtr didComposite; Chrome not support this
} NPPluginFuncs;
...
typedef struct _NPNetscapeFuncs {
  ...
  //NPN_DummyPtr initasyncsurfaceOBSOLETE; Chrome not support this
  //NPN_DummyPtr finalizeasyncsurfaceOBSOLETE; Chrome not support this
  //NPN_DummyPtr setcurrentasyncsurfaceOBSOLETE; Chrome not support this
} NPNetscapeFuncs;
