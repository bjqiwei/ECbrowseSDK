...
{
  return "application/yuntongxun-ecsdk-plugin application/yuntongxun-ecsdk-video-plugin";
}
...
{   
  ...
  NPAPIPluginBase * pPlugin = NULL;
  if (strcmp(pluginType,"application/yuntongxun-ecsdk-plugin") == 0 )
  {
	  pPlugin = new NPAPIECSDK(instance);
  }else if (strcmp(pluginType,"application/yuntongxun-ecsdk-video-plugin") == 0 )
  {
	  pPlugin = new NPAPIVideoObject(instance);
  }
...
NPError NPP_Destroy (NPP instance, NPSavedData** save)
{
  ...
  NPAPIPluginBase * pPlugin = (NPAPIPluginBase *)instance->pdata;
  if(pPlugin != NULL) {
    pPlugin->shut();
    delete pPlugin;
  }
...
NPError	NPP_GetValue(NPP instance, NPPVariable variable, void *value)
{
  ...
  NPAPIPluginBase * plugin = (NPAPIPluginBase  *)instance->pdata;
  if(plugin == NULL)
    return NPERR_GENERIC_ERROR;

  switch (variable) {
  case NPPVpluginNameString:
    *((const char **)value) = plugin->getName();
    break;
  case NPPVpluginDescriptionString:
    *((const char **)value) = plugin->getDescription();
    break;
